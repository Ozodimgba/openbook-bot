...
export declare class OpenBookV2Client {
    ...
    settleFundsIx(openOrdersPublicKey: PublicKey, openOrdersAccount: OpenOrdersAccount, marketPublicKey: PublicKey, market: MarketAccount, userBaseAccount: PublicKey, userQuoteAccount: PublicKey, referrerAccount: PublicKey | null, penaltyPayer: PublicKey | null, openOrdersDelegate?: Keypair): Promise<[TransactionInstruction, Signer[]]>;
